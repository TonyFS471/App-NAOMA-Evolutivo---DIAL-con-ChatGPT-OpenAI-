...
### Web landing page
- Open `http://localhost:8787/` to see a small status page with the correct endpoints.
- `GET /health` returns **200 OK** (Railway healthcheck).
- `GET /mcp` is **not a browser page**; if you open it in Chrome you may see **406 Not Acceptable** — that’s expected because it requires MCP client headers.
