...
### `analyze_with_dial`
Analyze queries using multiple DIAL architectures.

```json
{
  "query": "Explain quantum computing",
  "architectures": "naoma_evolutivo,ipa_introspection,math_engine"
}
```
...
Generate code using AgentCodex Pro.
...
### `solve_math`
Solve mathematical problems with MathEngine.

```json
{
  "problem": "Integrate x^2 from 0 to 5"
}
```
