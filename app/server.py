...
# ASGI export
# -----------------------------------------------------------------------------
# FastMCP needs its lifespan to run at startup. When serving under Uvicorn/Gunicorn,
# wrap the FastMCP ASGI app in a parent ASGI app and pass through the lifespan.
mcp_app = mcp.http_app(path=MCP_PATH)

from fastapi import FastAPI

app = FastAPI(lifespan=getattr(mcp_app, "lifespan", None))
app.mount("/", mcp_app)
